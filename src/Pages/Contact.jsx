        ...
        <div className="grid md:grid-cols-2 gap-10">
          ...
          <div className="bg-gray-900 border border-gray-800 rounded-lg p-8 shadow-lg flex flex-col space-y-6">
            ...
            <div className="w-full h-64 bg-gray-800 rounded-lg overflow-hidden">
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d102831.70678925244!2d-96.015424!3d36.154028!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x87b6928a6c9f1f2f%3A0x9b2f6f4b5b2f8b7a!2sTulsa%2C%20OK!5e0!3m2!1sen!2sus!4v1738440000000!5m2!1sen!2sus"
                className="w-full h-full border-0"
                allowFullScreen=""
                loading="lazy"
                referrerPolicy="no-referrer-when-downgrade"
                title="Google Map - Tulsa, Oklahoma"
              ></iframe>
